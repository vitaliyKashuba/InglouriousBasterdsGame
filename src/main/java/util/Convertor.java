...
public class Convertor {
    ...
    // TODO can be simplified by passing not map, but list of players
    ...
    @NotNull    // TODO can be simplified by passing not map, but list of players
    ...
    public static String convertMafiaPlayersForTelegram(@NotNull List<Player> players) {
        StringBuilder sb = new StringBuilder();
        players.forEach(p -> sb.append(p.getName()).append(" - ").append(p.getCharacter()).append("\n"));
        return sb.toString();
    }
}
