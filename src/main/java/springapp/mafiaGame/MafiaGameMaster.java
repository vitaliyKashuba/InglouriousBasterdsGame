...
import static springapp.game.Player.ClientType.WEB;
...
public class MafiaGameMaster extends BasicGameMaster        // TODO add master's helper? add secret voting ?
{
    ...
    private ListMultimap<Integer, String> roomsAndRoles;
            // key - room id, values - roles. String, but not enums because of user defined roles and using of IB methods with string characters
